...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { acronym: @region.acronym, region_name: @region.region_name } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { acronym: @region.acronym, region_name: @region.region_name } }
