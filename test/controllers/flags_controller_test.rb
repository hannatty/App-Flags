...
class FlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post flags_url, params: { flag: { acronym: @flag.acronym, capital: @flag.capital, state: @flag.state, url_img: @flag.url_img } }
    end
  ...
  test "should update flag" do
    patch flag_url(@flag), params: { flag: { acronym: @flag.acronym, capital: @flag.capital, state: @flag.state, url_img: @flag.url_img } }
